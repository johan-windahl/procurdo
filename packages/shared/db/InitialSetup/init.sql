...
GRANT CONNECT ON DATABASE procurdo      TO db_admin, web, bg;
GRANT CONNECT ON DATABASE procurdo_data TO db_admin, web, bg;

-- Connecta först till procurdo --
...
ALTER ROLE db_admin IN DATABASE procurdo SET search_path = public;
ALTER ROLE web      IN DATABASE procurdo SET search_path = public;
ALTER ROLE bg       IN DATABASE procurdo SET search_path = public;

-- Connecta först till procurdo_data --
\c procurdo_data
...
-- Nice UX: default search_path for roles in this DB
ALTER ROLE db_admin IN DATABASE procurdo_data SET search_path = public;
ALTER ROLE web      IN DATABASE procurdo_data SET search_path = public;
ALTER ROLE bg       IN DATABASE procurdo_data SET search_path = public;